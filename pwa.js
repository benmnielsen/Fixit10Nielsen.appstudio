...
const cacheName = 'Fixit10EthanMarchetti-2020-10-25 22:16:07.288027'; // unique value, generated each deploy
const contentToCache = [
  'code.js',
  'index.html',
  'includes/customerSelect.frm',
  'nsb/images/192.png',
  'nsb/images/512.png',
  'nsb/images/72.png',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit10EthanMarchetti'.length) === 'Fixit10EthanMarchetti') {
